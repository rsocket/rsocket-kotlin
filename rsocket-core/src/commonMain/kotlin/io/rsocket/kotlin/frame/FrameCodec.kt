...
internal class FrameCodec(
    ...
    fun decodeFrame(frame: Source): Frame = frame.readFrame()
    fun decodeFrame(expectedStreamId: Int, frame: Source): Frame = decodeFrame(frame).also {
    ...
    fun encodeFrame(frame: Frame): Source = frame.toSource()
