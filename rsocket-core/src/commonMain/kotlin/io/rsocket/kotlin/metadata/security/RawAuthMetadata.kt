...
@ExperimentalMetadataApi
public fun <AM : AuthMetadata> RawAuthMetadata.read(reader: AuthMetadataReader<AM>): AM {
...
@ExperimentalMetadataApi
public fun <AM : AuthMetadata> RawAuthMetadata.readOrNull(reader: AuthMetadataReader<AM>): AM? {
