...
class StreamIdGeneratorTest {
    ...
    fun testClientSequence() {
        val streamId = StreamIdGenerator.client()
    ...
    fun testServerSequence() {
        val streamId = StreamIdGenerator.server()
    ...
    @Test
    fun testWrapOdd() {
        val streamId = StreamIdGenerator(Int.MAX_VALUE - 3)
    ...
    @Test
    fun testWrapEven() {
        val streamId = StreamIdGenerator(Int.MAX_VALUE - 2)
